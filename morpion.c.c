...
void trad_tab_dec(uint8_t grille[3][3], FILE *f);
void print_all_transformations_dec_1d(uint8_t g[3][3], FILE *f);
...
//* cette partie est pour mettre les cas en valeurs decimales au lieu des symboles 
...
//* fin de la partie decimale------------------------------

//* la traduction d'un nombre decimal a un tableau de 1d
...
int main() {
    ...
    FILE *out2 = fopen("sortie2.txt", "w");
    uint8_t g[3][3] = {{0, 0, 0}, {0, 0, 0}, {0, 0, 0}};


    print_all_transformations_1d(g, out);
    print_all_transformations_dec_1d(g, out2);
